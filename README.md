...
Pale is a checkpoint storage library for machine learning models that deduplicates at the tensor level rather than the file level. It uses [content-addressable storage](https://en.wikipedia.org/wiki/Content-addressable_storage) (CAS) as its storage layer.
